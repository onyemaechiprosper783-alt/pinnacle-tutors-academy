  ...
  return (
    <main className="min-h-screen overflow-hidden bg-white">
      ...
      <section className="relative">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-orange-50 via-white to-amber-50" />

        <div className="absolute -left-24 top-20 -z-10 h-64 w-64 rounded-full bg-orange-200/30 blur-3xl" />
        <div className="absolute -right-24 top-40 -z-10 h-72 w-72 rounded-full bg-amber-200/30 blur-3xl" />

        <div className="mx-auto max-w-7xl px-5 pb-20 pt-16 sm:px-6 md:pb-28 md:pt-24">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-orange-100 bg-white/80 px-4 py-2 text-sm font-semibold text-orange-700 shadow-sm backdrop-blur">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/register"
                  className="rounded-2xl bg-orange-500 px-7 py-4 text-center font-bold text-white shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5 hover:bg-orange-600"
                >
                  Start Practicing →
                </Link>
                ...
                <Link
                  href="/jamb"
                  className="rounded-2xl border border-slate-200 bg-white px-7 py-4 text-center font-bold text-slate-800 shadow-sm transition hover:-translate-y-0.5 hover:border-orange-200 hover:text-orange-600"
                >
                  Explore JAMB
                </Link>
              </div>
            ...
            <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
              <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-r from-orange-500/20 to-amber-500/20 blur-2xl" />
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((feature) => (
              <div
                key={feature.title}
                className="group rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-900/5"
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-orange-50 text-2xl transition group-hover:scale-110">
                  {feature.icon}
                </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="grid gap-6 md:grid-cols-2">
            <Link
              href="/jamb"
              className="group overflow-hidden rounded-[2rem] bg-gradient-to-br from-orange-500 to-amber-500 p-8 text-white shadow-xl shadow-orange-900/10 transition hover:-translate-y-1"
            >
              ...
              <p className="mt-3 max-w-md leading-7 text-orange-100">
      ...
      <section className="px-5 pb-20 sm:px-6">
        <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-gradient-to-r from-orange-500 to-amber-500 px-6 py-14 text-center text-white shadow-2xl shadow-orange-900/20 sm:px-12">
          ...
          <Link
            href="/register"
            className="mt-8 inline-block rounded-2xl bg-white px-8 py-4 font-bold text-orange-600 shadow-lg transition hover:-translate-y-0.5 hover:bg-orange-50"
          >
            Create Your Account →
          </Link>
        </div>
