...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
     ...
     * it was stored temporarily in user metadata because the
     * account did not have a session before email confirmation.
     */
    ...
    if (pendingAccessKey) {
      ...
      /*
       * The key has now been claimed successfully.
       * Remove the temporary key from the user's metadata.
       */
    ...
    /*
     * Role comes from the database, not from anything
