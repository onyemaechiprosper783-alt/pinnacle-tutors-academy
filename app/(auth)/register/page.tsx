...
export default function RegisterPage() {
  ...
  const productKeyEnd = new Date('2026-10-01T00:00:00+01:00');
  const showProductKeyRequest = now < productKeyEnd;
  const showActivationKeyRequest = now >= activationRequestStart;
  const showBothKeys = now >= activationRequestStart && now < productKeyEnd;
