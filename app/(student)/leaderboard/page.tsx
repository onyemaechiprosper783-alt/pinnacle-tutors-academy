...
export default async function LeaderboardPage() {
  ...
  /*
   * =====================================================
   * FIND THE STUDENT'S CHALLENGE PARTICIPATION
   * =====================================================
   */
  ...
  /*
   * =====================================================
   * RESULTS ARE STILL LOCKED
   * =====================================================
   *
   * IMPORTANT:
   * We check this on the SERVER.
   *
   * No scores, ranks or other students are loaded before
   * the admin releases the results.
   */
  ...
  const leaderboard: LeaderboardEntry[] =
    (participants ?? []).map((item, index) => {
      ...
      return {
        ...
        student_name:
          profileMap.get(item.student_id) || 'Student',
        score,
      };
    });
  ...
  const myResult =
    leaderboard.find(
      (entry) => entry.student_id === caller.id
    ) ?? null;

  /*
   * =====================================================
   * RENDER RELEASED LEADERBOARD
   * =====================================================
   */
      ...
      <section>
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-[var(--muted)]">
            Students are ranked by their challenge score.
          </p>
        </div>
